package as3 {
	...
	/**
	 * This example demonstrates the touch drag 3d gesture.
	 */
	public class TouchDrag3D extends GestureWorks  {
		...
		public function TouchDrag3D():void {
			super();
		...
		private function setupGestures():void {
			...
			// add drag 3D gesture	-> see loaded gml file
