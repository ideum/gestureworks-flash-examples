package as3.layouts {
	 ...
	 */
	public class ContinuousTransform extends GestureWorks  {
		...
		private var circleLayout:CircleLayout3D;
		private var randomLayout:RandomLayout3D;
		
		public function ContinuousTransform():void {
			super();
			fullscreen = true;
		...
		private function setupScene():void {
			...
			circleLayout = new CircleLayout3D();
			circleLayout.tween = false;
			circleLayout.radius = 100;
			circleLayout.rot = new Vector3D(90, 0, 0);
			
			circleLayout.layout(container);
			
			randomLayout = new RandomLayout3D();
			randomLayout.tween = false;
			randomLayout.continuousTransform = true; // appends transformation to current
			
			randomLayout.posMin = new Vector3D(-25, -25, -25);
			randomLayout.posMax = new Vector3D(25, 25, 25);	
			
			randomLayout.rotMin = new Vector3D(0, 0, 0);
			randomLayout.rotMax = new Vector3D(0, 0, 0);			
						
			randomLayout.scaMin = new Vector3D(1, 1, 1);
			randomLayout.scaMax = new Vector3D(1, 1, 1);
			
			randomLayout.layout(container);
