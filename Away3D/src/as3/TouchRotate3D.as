package as3 {
	...
	/**
	 * This example demonstrates the touch rotate 3d gesture.
	 */
	public class TouchRotate3D extends GestureWorks  {
		...
		public function TouchRotate3D():void {
			super();
		...
		private function setupGestures():void {
			...
			// add rotate 3D gesture	-> see loaded gml file
			tO.gestureList = { "n-rotate-3d":true }; 	
