package 
{
	...
	public class Main extends GestureWorks 
	{
		...
		override protected function gestureworksInit():void 
		{
			...
			touchC.affineTransform = false;
			touchC.nativeTransform = false;
